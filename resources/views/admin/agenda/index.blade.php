...
@section('Content')
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('admin-agenda.edit', $data->slug) }}">
                                                <i class="bx bx-edit-alt me-1"></i> Edit</a>
                                            <button type="button" class="dropdown-item text-danger"
                                                onclick="deleteAgenda('{{ route('admin-agenda.destroy', $data->slug) }}')">
    ...
    <script>
        function deleteAgenda(url) {
            Swal.fire({
                title: 'Yakin mau hapus?',
                text: 'Data agenda dan semua gambarnya akan dihapus permanen!',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(url, {
                        ...
                        .then(data => {
                            Swal.fire(
                                'Terhapus!',
                                data.message ?? 'Agenda berhasil dihapus.',
                                'success'
                            ).then(() => {
                                location.reload();
                            });

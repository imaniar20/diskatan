            ...
            <div class="col-md-6" style="border-bottom: 0px">
                <div class="card mb-4">
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        <form class="mb-4" id="editProgram" action="{{ route('admin-program.update', $program->id) }}"
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-control" name="kategori" id="kategori">
                                        ...
                                        @foreach ($kategori as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $program->kategori_id ? 'selected' : '' }}>
                                                {{ $item->nama }}</option>
                                        @endforeach
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama" aria-label="Nama"
                                        value="{{ $program->name }}" id="name" name="name"
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="number" min="1945" max="{{ date('Y') + 5 }}"
                                        value="{{ $program->tahun }}" class="form-control" placeholder="Tahun"
